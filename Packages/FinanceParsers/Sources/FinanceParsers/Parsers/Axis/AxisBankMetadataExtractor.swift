...
/// Extracts account metadata from Axis Bank CSV rows (header block in first 10 rows).
///
/// Only account number (last 4 digits) is reliably available in the Axis CSV format;
