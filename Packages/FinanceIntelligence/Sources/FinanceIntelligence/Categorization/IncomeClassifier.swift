...
public struct IncomeClassifier: Sendable {
    ...
    public func predict(narration: String) -> (isIncome: Bool, confidence: Double)? {
        // TODO(FINOS-23): Load income_classifier_v0.1.pkl + vectorizer_income_v0.1.pkl
        // For now: return nil to use fallback rule-based detection (salary keyword + structure)
        return nil
    }
}
