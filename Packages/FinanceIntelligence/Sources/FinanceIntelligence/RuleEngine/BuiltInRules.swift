...
extension BuiltInRules {
    static var incomeRules: [Rule] {[
        Rule(
            ...
            outcome: RuleOutcome(categoryId: "income", subcategoryId: "income.salary",
                                 intent: .salary, confidence: 0.95)
        ),
        Rule(
            ...
            outcome: RuleOutcome(categoryId: "income", subcategoryId: "income.salary",
                                 intent: .salary, confidence: 0.93)
        ),
        Rule(
            id: "income.refund",
            priority: 3,
            condition: .tokenContainsAny(["refund", "reversal", "chargeback"]),
            outcome: RuleOutcome(categoryId: "income", subcategoryId: "income.refund",
                                 intent: .refund, confidence: 0.90)
        ),
        Rule(
            id: "income.cashback",
            priority: 4,
            ...
            outcome: RuleOutcome(categoryId: "income", subcategoryId: "income.refund",
                                 intent: .cashback, confidence: 0.88)
        ),
    ]}
}
...
extension BuiltInRules {
    static var housingRules: [Rule] {[
        Rule(
            ...
            outcome: RuleOutcome(categoryId: "housing", subcategoryId: "housing.rent",
                                 intent: .rent, confidence: 0.88)
        ),
    ]}
}
...
extension BuiltInRules {
    static var loanRules: [Rule] {[
        ...
        Rule(
            id: "loan.interest",
            priority: 4,
            condition: .tokenContainsAny(["interest charge", "finance charge", "late payment fee", "penal interest"]),
            outcome: RuleOutcome(categoryId: "fees", subcategoryId: "fees.interest",
                                 intent: .interestPayment, confidence: 0.88)
        ),
    ]}
}
...
extension BuiltInRules {
    static var shoppingRules: [Rule] {[
        Rule(
            ...
            outcome: RuleOutcome(categoryId: "shopping", subcategoryId: "shopping.online",
                                 intent: .shopping, confidence: 0.82)
        ),
    ]}
}
