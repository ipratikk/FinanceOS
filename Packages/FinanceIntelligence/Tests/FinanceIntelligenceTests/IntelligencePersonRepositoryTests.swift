...
private func makeRepo() throws -> GRDBIntelligencePersonRepository {
    try GRDBIntelligencePersonRepository(dbQueue: makeTestDatabase())
}

// MARK: - findOrCreate: New Person

@Test
func personRepo_findOrCreate_createNewPerson() async throws {
...
@Test
func personRepo_findOrCreate_titleCasesName() async throws {
    let repo = try makeRepo()
...
@Test
func personRepo_findOrCreate_storesUPIHandle() async throws {
    let repo = try makeRepo()
...
@Test
func personRepo_findOrCreate_setsFirstAndLastSeen() async throws {
    let repo = try makeRepo()
    let date = Date()
...
@Test
func personRepo_findOrCreate_deduplicatesBySameName() async throws {
    let repo = try makeRepo()
    let date = Date()
...
@Test
func personRepo_findOrCreate_incrementsTransactionCount() async throws {
    let repo = try makeRepo()
    let date = Date()
...
@Test
func personRepo_findOrCreate_stripsTitle_mr() async throws {
    let repo = try makeRepo()
...
@Test
func personRepo_findOrCreate_stripsTitle_dr() async throws {
    let repo = try makeRepo()
...
@Test
func personRepo_findOrCreate_distinctNamesCreateDistinctPersons() async throws {
    let repo = try makeRepo()
    let date = Date()
    let p1 = try await repo.findOrCreate(name: "RITIK GUPTA", upiHandle: nil, date: date)
...
@Test
func personRepo_findOrCreate_deduplicatesByUPIHandle() async throws {
    let repo = try makeRepo()
    let date = Date()
...
@Test
func personRepo_findOrCreate_upiHandleStoredLowercase() async throws {
    let repo = try makeRepo()
...
@Test
func personRepo_findOrCreate_addsUPIHandleOnSubsequentCall() async throws {
    let repo = try makeRepo()
    let date = Date()
...
@Test
func personRepo_fetchAll_emptyInitially() async throws {
    let repo = try makeRepo()
...
@Test
func personRepo_fetchAll_returnsAllPersons() async throws {
    let repo = try makeRepo()
    let date = Date()
...
@Test
func personRepo_fetchAll_deduplicatedCountCorrect() async throws {
    let repo = try makeRepo()
    let date = Date()
    _ = try await repo.findOrCreate(name: "RITIK GUPTA", upiHandle: nil, date: date)
...
@Test
func personRepo_personForId_returnsExistingPerson() async throws {
    let repo = try makeRepo()
...
@Test
func personRepo_personForId_returnsNilForUnknownID() async throws {
    let repo = try makeRepo()
...
@Test
func personRepo_aliases_recordedForNewPerson() async throws {
    let repo = try makeRepo()
