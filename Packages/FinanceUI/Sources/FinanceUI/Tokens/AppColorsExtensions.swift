...
extension AppColors {
    ...
    public static let dividerDefault = Color.white.opacity(0.06)
    public static let borderSubtle = Color.white.opacity(0.08)
    public static let borderDefault = Color.white.opacity(0.12)
    public static let overlayLight = Color.white.opacity(0.03)
    public static let overlayMedium = Color.white.opacity(0.05)

    // MARK: - Semantic Opacity Variants

    public static let accentLight = accent.opacity(0.07)
    public static let accentMedium = accent.opacity(0.15)
    public static let accentDark = accent.opacity(0.5)

    public static let debitLight = debit.opacity(0.12)
    public static let creditLight = credit.opacity(0.12)

    // MARK: - Skeleton / Loading States

    public static let skeletonLight = Color.white.opacity(0.04)
    public static let skeletonMedium = Color.white.opacity(0.08)
