...
## Corpus Check
- 209 files · ~42,102 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1523 nodes · 2110 edges · 145 communities (73 shown, 72 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 151 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `285ad6f6`
...
4. `TabularTransactionDecoder` - 17 edges
5. `ICICIMetadataExtractor` - 16 edges
6. `HDFCPDFParser` - 16 edges
7. `FinanceOS Coding Standards` - 16 edges
8. `NormalizedRow` - 15 edges
9. `ColumnRole` - 14 edges
10. `StatementFileFormat` - 14 edges
...
## Communities (145 total, 72 thin omitted)
...
Cohesion: 0.05
Nodes (12): AmexCardCSVMapper, AmexCardCSVNormalizer, HDFCBankTXTMapper, HDFCBankTXTNormalizer, HDFCCardCSVMapper, HDFCCardCSVNormalizer, ICICIBankCSVMapper, ICICIBankCSVNormalizer (+4 more)
...
Cohesion: 0.08
Nodes (25): AsyncParsableCommand, CLIError, fileNotFound, parseError, unsupportedFormat, CompareCommand, FinanceParserCLI, ListSourcesCommand (+17 more)
...
Cohesion: 0.07
Nodes (7): AmexCardCSVParser, UnifiedStatementParser, HDFCBankTXTParser, HDFCCardCSVParser, ICICIBankCSVParser, ICICICardCSVParser, date
...
Cohesion: 0.12
Nodes (12): FinanceCard, SupportedSourcesView, TargetSelectionSection, DropZoneView, FileSelectionPlaceholder, SourcePickerSection, AdaptiveNavigation, DetailRouter (+4 more)
...
Cohesion: 0.17
Nodes (5): AccountRepository, CardRepository, MockAccountRepository, MockCardRepository, MockAccountRepository
...
## Knowledge Gaps
- **239 isolated node(s):** `csv`, `txt`, `unrecognizedFormat`, `couldNotReadFile`, `id` (+234 more)
...
- **Why does `ImportView` connect `Community 19` to `Community 24`, `Community 37`?**
  _High betweenness centrality (0.124) - this node is a cross-community bridge._
- **Why does `TargetChoice` connect `Community 19` to `Community 8`, `Community 37`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `StatementSource` connect `Community 8` to `Community 33`, `Community 26`, `Community 11`?**
  _High betweenness centrality (0.049) - this node is a cross-community bridge._
- **Are the 33 inferred relationships involving `String` (e.g. with `.run()` and `.extractCardLast4()`) actually correct?**
  _`String` has 33 INFERRED edges - model-reasoned connections that need verification._
- **What connects `csv`, `txt`, `unrecognizedFormat` to the rest of the system?**
