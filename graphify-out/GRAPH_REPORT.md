...
## Corpus Check
- 199 files · ~44,614 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1322 nodes · 1790 edges · 137 communities (62 shown, 75 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 112 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `86d25add`
...
## Communities (137 total, 75 thin omitted)
...
Cohesion: 0.4
Nodes (5): StepStatus, done, failed, pending, running
...
- **Why does `ImportView` connect `Community 11` to `Community 21`?**
  _High betweenness centrality (0.113) - this node is a cross-community bridge._
- **Why does `TargetChoice` connect `Community 11` to `Community 5`?**
  _High betweenness centrality (0.109) - this node is a cross-community bridge._
- **Why does `StatementSource` connect `Community 5` to `Community 35`, `Community 12`?**
