...
## Corpus Check
- 79 files · ~18,163 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 644 nodes · 847 edges · 52 communities (30 shown, 22 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 37 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e6c2d451`
...
Cohesion: 0.05
Nodes (21): DatabaseManager, DetectedStatementMetadata, StatementDetector, Hashable, ImportResult, StatementParser, TransactionImporting, TransactionImportTarget (+13 more)
...
Cohesion: 0.1
Nodes (13): TargetChoice, account, card, createAccount, createCard, fileFormat(), formatError(), fuzzyMatch() (+5 more)
...
Cohesion: 0.15
Nodes (11): CaseIterable, StatementFileFormat, csv, pdf, xls, xlsx, BankProviderType, bank (+3 more)
...
Cohesion: 0.48
Nodes (5): convertXLSToCSV(), extractRows(), parseCSVString(), parseStatement(), String
...
- **Why does `ImportView` connect `Community 21` to `Community 0`, `Community 33`, `Community 3`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `ParsedStatement` connect `Community 2` to `Community 17`, `Community 1`, `Community 6`?**
  _High betweenness centrality (0.091) - this node is a cross-community bridge._
- **Why does `TargetChoice` connect `Community 3` to `Community 33`, `Community 1`?**
