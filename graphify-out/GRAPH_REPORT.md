...
## Corpus Check
- 72 files · ~13,064 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 474 nodes · 605 edges · 42 communities (22 shown, 20 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 18 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c3ca2c11`
...
9. `WorksheetParserDelegate` - 9 edges
10. `ICICIBankStatementParser` - 9 edges
...
Cohesion: 0.18
Nodes (6): AccountRepository, CardRepository, MockAccountRepository, MockCardRepository, MockAccountRepository, MockCardRepository
...
- **Why does `ICICIBankStatementParser` connect `Community 7` to `Community 4`?**
  _High betweenness centrality (0.076) - this node is a cross-community bridge._
- **Why does `TransactionImportTarget` connect `Community 9` to `Community 1`, `Community 3`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `ImportView` connect `Community 18` to `Community 8`, `Community 9`, `Community 15`?**
