...
## Corpus Check
- 113 files · ~30,670 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1009 nodes · 1417 edges · 97 communities (58 shown, 39 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 77 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `58c84ae7`
...
Cohesion: 0.08
Nodes (17): HDFCLineClassifier, StatementFileFormat, csv, pdf, txt, xlsx, convertXLSToCSV(), extractRows() (+9 more)
...
Cohesion: 0.14
Nodes (10): CustomStringConvertible, Error, TransactionImportError, invalidAmount, invalidDate, malformedFile, missingRequiredColumn, passwordProtected (+2 more)
...
- **Why does `ImportView` connect `Community 1` to `Community 31`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `StatementSource` connect `Community 1` to `Community 17`, `Community 2`, `Community 13`?**
