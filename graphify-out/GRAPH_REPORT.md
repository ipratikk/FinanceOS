...
## Corpus Check
- 179 files · ~37,580 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1337 nodes · 1812 edges · 131 communities (67 shown, 64 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 112 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9705fd30`
...
8. `ParsedStatement` - 14 edges
9. `ImportView` - 13 edges
10. `TransactionImportError` - 12 edges
...
## Communities (131 total, 64 thin omitted)
...
Cohesion: 0.05
Nodes (39): AmexCardStatementParser, CodingKey, CustomStringConvertible, Error, CodingKeys, amountMinorUnits, currencyCode, description (+31 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (15): StatementSourceType, bankAccount, creditCard, CSVRowReader, HDFCCardStatementParser, HDFCLineClassifier, ICICICardStatementParser, convertXLSToCSV() (+7 more)
...
Cohesion: 0.06
Nodes (6): HDFCBankStatementParser, ICICIBankStatementParser, AmexCardStatementParser, HDFCBankStatementParser, ICICICardStatementParser, InstitutionStatementParser
...
Cohesion: 0.07
Nodes (13): InstitutionStatementParser, DetectedStatementMetadata, StatementDetector, ImportResult, StatementParser, TransactionImporting, InstitutionStatementParser, AccountRepository (+5 more)
...
Cohesion: 0.1
Nodes (6): BankRepository, GRDBBankRepository, GRDBCardRepository, grdbDelete(), grdbInsert(), grdbUpdate()
...
Cohesion: 0.13
Nodes (4): MockBankRepository, MockTransactionImporter, MockTransactionRepository, TransactionImporting
...
Cohesion: 0.15
Nodes (4): AccountRepository, MockAccountRepository, MockAccountRepository, GRDBAccountRepository
...
Cohesion: 0.22
Nodes (5): Codable, BalanceValidationResult, FailedRow, ParserDiagnostics, ParseResult
...
Cohesion: 0.21
Nodes (4): StatementParserRegistry, StatementSourceType, bankAccount, creditCard
...
## Knowledge Gaps
- **220 isolated node(s):** `csv`, `txt`, `xlsx`, `pdf`, `missingRequiredColumn` (+215 more)
...
- **Why does `ImportView` connect `Community 16` to `Community 41`, `Community 21`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `TargetChoice` connect `Community 16` to `Community 41`, `Community 5`?**
  _High betweenness centrality (0.105) - this node is a cross-community bridge._
- **Why does `StatementSource` connect `Community 5` to `Community 2`, `Community 11`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Are the 33 inferred relationships involving `String` (e.g. with `.extractCardLast4()` and `.parse()`) actually correct?**
