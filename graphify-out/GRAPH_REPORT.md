...
## Corpus Check
- 182 files · ~39,230 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1376 nodes · 1885 edges · 134 communities (64 shown, 70 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 113 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6380fd2e`
...
## Communities (134 total, 70 thin omitted)
...
Cohesion: 0.06
Nodes (15): CSVRowReader, HDFCCardStatementParser, HDFCLineClassifier, ICICICardStatementParser, convertXLSToCSV(), extractRows(), findSSConvert(), init() (+7 more)
...
- **Why does `ImportView` connect `Community 6` to `Community 23`?**
  _High betweenness centrality (0.099) - this node is a cross-community bridge._
- **Why does `TargetChoice` connect `Community 6` to `Community 7`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `StatementSource` connect `Community 7` to `Community 2`, `Community 14`?**
