...
## Corpus Check
- 154 files · ~34,947 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1185 nodes · 1614 edges · 127 communities (62 shown, 65 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 89 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7bfc02ff`
...
Cohesion: 0.06
Nodes (16): AccountTransactionsViewModel, CardTransactionsViewModel, HDFCLineClassifier, convertXLSToCSV(), extractRows(), findSSConvert(), init(), parseCSVString() (+8 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (19): FetchableRecord, Identifiable, DefaultTransactionImporter, FinanceParsers.TransactionImportError, Account, Columns, Bank, Columns (+11 more)
...
Cohesion: 0.08
Nodes (12): DetectedStatementMetadata, StatementDetector, ImportResult, StatementParser, TransactionImporting, InstitutionStatementParser, AccountRepository, BankRepository (+4 more)
...
Cohesion: 0.17
Nodes (11): ParsedStatement, ParsedTransaction, StatementFileFormat, csv, pdf, txt, xlsx, StatementMetadata (+3 more)
...
Cohesion: 0.12
Nodes (19): CaseIterable, Codable, AccountType, credit, current, savings, BankProviderType, bank (+11 more)
...
Cohesion: 0.22
Nodes (8): CustomStringConvertible, Error, TransactionImportError, invalidAmount, invalidDate, missingRequiredColumn, passwordProtected, platformUnavailable
...
Cohesion: 0.29
Nodes (3): CSVStatementParser, DefaultTransactionImporter, unsupportedFormat
...
## Knowledge Gaps
- **175 isolated node(s):** `dashboard`, `transactions`, `accounts`, `cards`, `banks` (+170 more)
...
- **Why does `ImportView` connect `Community 12` to `Community 18`, `Community 36`?**
  _High betweenness centrality (0.131) - this node is a cross-community bridge._
- **Why does `TargetChoice` connect `Community 12` to `Community 36`, `Community 6`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `StatementSource` connect `Community 6` to `Community 0`, `Community 10`, `Community 19`?**
...
- **What connects `dashboard`, `transactions`, `accounts` to the rest of the system?**
