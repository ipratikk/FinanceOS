...
## Corpus Check
- 113 files · ~30,420 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1009 nodes · 1415 edges · 98 communities (59 shown, 39 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 77 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `96d04e87`
...
Cohesion: 0.1
Nodes (10): HDFCLineClassifier, convertXLSToCSV(), extractRows(), findSSConvert(), init(), parseCSVString(), parseStatement(), HDFCCardStatementParser (+2 more)
...
Cohesion: 0.09
Nodes (8): AsyncParsableCommand, FinanceParserCLI, ParseCommand, HDFCPDFParser, HDFCTextBasedParser, ReconstructedTransaction, FinanceParsersTests, XCTestCase
...
Cohesion: 0.08
Nodes (10): ImportResult, StatementParser, TransactionImporting, InstitutionStatementParser, StatementParserRegistry, AccountRepository, BankRepository, CardRepository (+2 more)
...
Cohesion: 0.14
Nodes (4): BankRepository, MockAccountRepository, MockBankRepository, MockTransactionImporter
...
Cohesion: 0.2
Nodes (6): CreateNewTargetSheet, SupportedSourcesView, TargetSelectionSection, View, TransactionFilterView, TransactionListContentView
...
- **Why does `TargetChoice` connect `Community 9` to `Community 28`?**
  _High betweenness centrality (0.062) - this node is a cross-community bridge._
- **Why does `StatementSource` connect `Community 28` to `Community 25`, `Community 3`, `Community 13`?**
