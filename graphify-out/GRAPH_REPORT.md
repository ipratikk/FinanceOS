...
## Corpus Check
- 199 files · ~45,660 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1579 nodes · 2192 edges · 168 communities (72 shown, 96 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 162 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4ffb2b45`
...
## Communities (168 total, 96 thin omitted)
...
Cohesion: 0.11
Nodes (15): Codable, FetchableRecord, Identifiable, Account, Bank, Card, Columns, Institution (+7 more)
...
Cohesion: 0.09
Nodes (9): GRDBSpendingService, MonthlySpendingSummary, SpendingServiceProtocol, SpendingTotals, Equatable, ParsedStatement, StatementMetadata, ParseResult (+1 more)
...
Cohesion: 0.1
Nodes (13): FinanceCard, SectionHeader, SupportedSourcesView, TargetSelectionSection, DropZoneView, FileSelectionPlaceholder, SourcePickerSection, AdaptiveNavigation (+5 more)
...
Cohesion: 0.12
Nodes (17): CodingKey, CodingKeys, amountMinorUnits, currencyCode, description, id, postedAt, rewardPoints (+9 more)
...
Cohesion: 0.15
Nodes (3): MockAccountRepository, MockCardRepository, MockTransactionImporter
...
- **Why does `TargetChoice` connect `Community 9` to `Community 11`?**
  _High betweenness centrality (0.135) - this node is a cross-community bridge._
- **Why does `ImportView` connect `Community 9` to `Community 18`?**
  _High betweenness centrality (0.130) - this node is a cross-community bridge._
- **Why does `StatementSource` connect `Community 11` to `Community 24`, `Community 25`, `Community 6`?**
