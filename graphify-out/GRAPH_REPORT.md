...
## Corpus Check
- 204 files · ~47,035 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1614 nodes · 2218 edges · 163 communities (63 shown, 100 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 161 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9c2f38dd`
...
## Communities (163 total, 100 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.05
Nodes (23): AsyncParsableCommand, CLIError, fileNotFound, parseError, unsupportedFormat, CompareCommand, FinanceParserCLI, ListSourcesCommand (+15 more)
...
Cohesion: 0.05
Nodes (34): StatementSource, amex, hdfcBank, hdfcCard, iciciBank, iciciCard, Hashable, StatementSource (+26 more)
...
Cohesion: 0.08
Nodes (15): MonthlySpendingSummary, SpendingServiceProtocol, SpendingTotals, Codable, BalanceValidationResult, FailedRow, ParserDiagnostics, Equatable (+7 more)
...
Cohesion: 0.12
Nodes (12): TransactionRowView, SupportedSourcesView, TargetSelectionSection, DropZoneView, FileSelectionPlaceholder, SourcePickerSection, AdaptiveNavigation, DetailRouter (+4 more)
...
- **Why does `ImportView` connect `Community 5` to `Community 22`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `TargetChoice` connect `Community 5` to `Community 7`?**
  _High betweenness centrality (0.115) - this node is a cross-community bridge._
- **Why does `ColumnRole` connect `Community 7` to `Community 0`, `Community 11`, `Community 13`?**
